...
Works with the tools you know and ❤️. Welcome to our community 👪

- Get Started: https://panel.holoviz.org/
- Join the Community: https://discourse.holoviz.org/
- Contribute: https://github.com/holoviz/panel

Follow us on [Twitter](https://twitter.com/Panel_org) or [LinkedIn](https://www.linkedin.com/company/79754450).
¨
...
You can use [hvplot .interactive](https://hvplot.holoviz.org/user_guide/Interactive.html) to make 
your dataframes interactive.
