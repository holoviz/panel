...
class Bootstrap(Design):
    modifiers = {
        Accordion: {"active_header_background": "var(--bs-surface-bg)"},
        Card: {"children": {"margin": (10, 10)}, "button_css_classes": ["card-button"], "margin": (10, 5)},
        Tabulator: {"theme": "bootstrap5", "theme_classes": ["table-sm"]},
        Viewable: {"stylesheets": [Inherit, f"{CDN_DIST}bundled/theme/bootstrap.css"]},
    }
    ...
    _resources = {"css": {"bootstrap": CSS_URLS["bootstrap5"]}, "js": {"bootstrap": JS_URLS["bootstrap5"]}}
