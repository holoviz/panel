...
class Card(Column):
    ...
    _rename: ClassVar[Mapping[str, str | None]] = {"title": None, "header": None, "title_css_classes": None}

    _stylesheets: ClassVar[List[str]] = [f"{CDN_DIST}css/card.css"]
