...
class FlexBox(ListLike, ReactiveHTML):
    ...
    align_items = param.Selector(
        default="flex-start",
        objects=["stretch", "flex-start", "flex-end", "center", "baseline", "first baseline", "last baseline", "start", "end", "self-start", "self-end"],
        doc="""
    ...
    justify_content = param.Selector(
        default="flex-start",
        objects=["flex-start", "flex-end", "center", "space-between", "space-around", "space-evenly", "start", "end", "left", "right"],
        doc="""
