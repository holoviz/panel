...
class TextEditor(Widget):
    ...
    _rename: ClassVar[Mapping[str, str | None]] = {"name": "name", "value": "text"}

    def _get_model(self, doc: Document, root: Optional[Model] = None, parent: Optional[Model] = None, comm: Optional[Comm] = None) -> Model:
        if self._widget_type is None:
            self._widget_type = lazy_load("panel.models.quill", "QuillInput", isinstance(comm, JupyterComm), root, ext="texteditor")
