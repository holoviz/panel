...
def json_input():
    return (
        '{"initialViewState": {"bearing": -27.36, "latitude": 52.2323, '
...
@pytest.fixture
def mapbox_api_key():
    return "pk.eyJ1IjoibWFyY3Nrb3ZtYWRzZW4iLCJhIjoiY2s1anMzcG5rMDYzazNvcm10NTFybTE4cSJ9." "TV1XBgaMfR-iTLvAXM_Iew"
