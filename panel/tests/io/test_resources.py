...
def test_resources_model_server(document):
    ...
    with set_resource_mode("server"):
        with set_curdoc(document):
            ...
            assert resources.css_files == ["static/extensions/panel/bundled/datatabulator/tabulator-tables@5.5.0/dist/css/tabulator_simple.min.css"]
...
def test_resources_model_cdn(document):
    ...
    with set_resource_mode("cdn"):
        with set_curdoc(document):
            ...
            assert resources.css_files == [f"{CDN_DIST}bundled/datatabulator/tabulator-tables@5.5.0/dist/css/tabulator_simple.min.css"]
