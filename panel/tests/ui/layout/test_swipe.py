...
def test_swipe_fixed_width(page):
    ...
    print(slider_bbox["x"] + (bbox["width"] / 4.0))
    slider.drag_to(slider, target_position={"x": (bbox["width"] / 4.0), "y": 0}, force=True)

    assert (
        page.locator(".swipe-container .outer")
        .nth(0)
        .evaluate(
            """(element) =>
        window.getComputedStyle(element).getPropertyValue('clip-path')"""
        )
        == "polygon(0% 0%, calc(75% + 5px) 0%, calc(75% + 5px) 100%, 0% 100%)"
    )
    assert (
        page.locator(".swipe-container .outer")
        .nth(1)
        ...
        == "polygon(calc(75% + 5px) 0%, 100% 0%, 100% 100%, calc(75% + 5px) 100%)"
    )
    ...
    assert (
        ...
        == "polygon(0% 0%, calc(25% + 5px) 0%, calc(25% + 5px) 100%, 0% 100%)"
    )
    assert (
        page.locator(".swipe-container .outer")
        .nth(1)
        ...
        == "polygon(calc(25% + 5px) 0%, 100% 0%, 100% 100%, calc(25% + 5px) 100%)"
    )
