...
def test_gridbox_unequal(page):
    grid = GridBox(
        Spacer(width=50, height=10), Spacer(width=40, height=10), Spacer(width=60, height=20), Spacer(width=20, height=10), Spacer(width=20, height=30), ncols=4
    )
...
def test_gridbox_stretch_both(page):
    grid = Column(
        GridBox(Spacer(sizing_mode="stretch_both"), Spacer(sizing_mode="stretch_both"), Spacer(sizing_mode="stretch_both"), ncols=2, sizing_mode="stretch_both"),
        height=800,
        width=600,
    )
