...
vega4_selection_example = {
    ...
    "mark": {"type": "point"},
    "encoding": {
        "color": {"condition": {"selection": "brush", "field": "Species", "type": "nominal"}, "value": "lightgray"},
        "x": {"field": "Beak Length (mm)", "scale": {"zero": False}, "type": "quantitative"},
        "y": {"field": "Beak Depth (mm)", "scale": {"zero": False}, "type": "quantitative"},
    },
    "height": 250,
...
vega5_selection_example = {
    ...
    "mark": {"type": "point"},
    "encoding": {
        "color": {"condition": {"param": "brush", "field": "Species", "type": "nominal"}, "value": "lightgray"},
        "x": {"field": "Beak Length (mm)", "scale": {"zero": False}, "type": "quantitative"},
        "y": {"field": "Beak Depth (mm)", "scale": {"zero": False}, "type": "quantitative"},
    },
    "height": 250,
...
vega_inline_example = {
    ...
    "data": {"name": "data-2f2c0ff233b8675aa09202457ebe7506", "format": {"property": "features", "type": "json"}},
    "mark": "geoshape",
    "encoding": {"color": {"type": "quantitative", "field": "properties.percent_no_internet"}},
        ...
        "data-778223ce4ff5da49611148b060c0cd3d": [
            {
                "bid": "SR01-01",
                "type": "Feature",
                "geometry": {"type": "Polygon", "coordinates": [[[120.0, 855.0], [120.0, 925.0], [20.0, 925.0], [20.0, 855.0], [120.0, 855.0]]]},
            },
            {
                "bid": "SR02-02",
                "type": "Feature",
                "geometry": {"type": "Polygon", "coordinates": [[[120.0, 940.0], [120.0, 1010.0], [20.0, 1010.0], [20.0, 940.0], [120.0, 940.0]]]},
            },
            {
                "bid": "SR03-03",
                "type": "Feature",
                "geometry": {"type": "Polygon", "coordinates": [[[240.0, 940.0], [240.0, 1010.0], [140.0, 1010.0], [140.0, 940.0], [240.0, 940.0]]]},
            },
        ]
    },
}
