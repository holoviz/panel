...
vega_inline_example = {
    ...
    "data": {
        "name": "data-2f2c0ff233b8675aa09202457ebe7506",
        "format": {"property": "features", "type": "json"},
    },
    "mark": "geoshape",
    "encoding": {
        "color": {"type": "quantitative", "field": "properties.percent_no_internet"}
    },
...
def altair_example():
    ...
    chart = (
        alt.Chart(data)
        .mark_bar()
        .encode(x="x:O", y="y:Q")  # specify ordinal data  # specify quantitative data
    )
    return chart
