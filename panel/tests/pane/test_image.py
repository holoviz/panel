...
twopixel = dict(
    gif=b"R0lGODlhAgABAPAAAEQ6Q2NYYCH5BAAAAAAAIf8LSW1hZ2VNYWdpY2sNZ2FtbWE" + b"9MC40NTQ1NQAsAAAAAAIAAQAAAgIMCgA7",
    png=b"iVBORw0KGgoAAAANSUhEUgAAAAIAAAABCAYAAAD0In+KAAAAFElEQVQIHQEJAPb" + b"/AWNYYP/h4uMAFL0EwlEn99gAAAAASUVORK5CYII=",
    ...
    ico=b"AAABAAEAAgEAAAEAIAA0AAAAFgAAACgAAAACAAAAAgAAAAEAIAAAAAAACAAAAHQ" + b"SAAB0EgAAAAAAAAAAAAD//////////wAAAAA=",
)
