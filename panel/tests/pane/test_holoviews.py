...
def test_holoviews_date_slider_widgets_from_holomap():
    ...
    assert widgets[0].options == OrderedDict(
        [("2016-01-01 00:00:00", dt.datetime(2016, 1, 1)), ("2016-01-02 00:00:00", dt.datetime(2016, 1, 2)), ("2016-01-03 00:00:00", dt.datetime(2016, 1, 3))]
    )
...
def test_holoviews_property_override_old_method(document, comm):
    ...
    with warnings.catch_warnings():
        ...
        pane = pn.panel(c1, backend="bokeh", background="red", css_classes=["test_class"])
