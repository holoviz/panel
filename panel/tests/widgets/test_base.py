...
excluded = (Ace, BaseTable, CompositeWidget, Dial, FileDownload, LinearGauge, LoadingSpinner, ToggleGroup, Terminal, Tqdm)

all_widgets = [w for w in param.concrete_descendents(Widget).values() if not w.__name__.startswith("_") and not issubclass(w, excluded)]
