...
def test_select_change_options_on_watch(document, comm):
    select = Select(options=OrderedDict([("A", "A"), ("1", 1), ("C", object)]), value="A", name="Select")
...
def test_multi_select(document, comm):
    select = MultiSelect(options=OrderedDict([("A", "A"), ("1", 1), ("C", object)]), value=[object, 1], name="Select")
...
def test_multi_choice(document, comm):
    choice = MultiChoice(options=OrderedDict([("A", "A"), ("1", 1), ("C", object)]), value=[object, 1], name="MultiChoice")
...
def test_toggle_group_error_init(document, comm):
    with pytest.raises(ValueError):
        ToggleGroup(options=OrderedDict([("A", "A"), ("1", 1), ("C", object)]), value=1, name="RadioButtonGroup", widget_type="button", behavior="check")

    with pytest.raises(ValueError):
        ToggleGroup(options=OrderedDict([("A", "A"), ("1", 1), ("C", object)]), value=[1, object], name="RadioButtonGroup", widget_type="button", behavior="radio")

    with pytest.raises(ValueError):
        ToggleGroup(options=OrderedDict([("A", "A"), ("1", 1), ("C", object)]), value=[1, object], name="RadioButtonGroup", widget_type="buttons")

    with pytest.raises(ValueError):
        ToggleGroup(options=OrderedDict([("A", "A"), ("1", 1), ("C", object)]), value=[1, object], name="RadioButtonGroup", behavior="checks")


def test_toggle_group_check(document, comm):
    for widget_type in ToggleGroup._widgets_type:
        select = ToggleGroup(
            options=OrderedDict([("A", "A"), ("1", 1), ("C", object)]), value=[1, object], name="CheckButtonGroup", widget_type=widget_type, behavior="check"
        )
...
def test_toggle_group_radio(document, comm):
    for widget_type in ToggleGroup._widgets_type:
        select = ToggleGroup(options=OrderedDict([("A", "A"), ("1", 1), ("C", object)]), value=1, name="RadioButtonGroup", widget_type=widget_type, behavior="radio")
