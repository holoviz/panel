...
def get_app():
    ...
    run_ls_l_in_subprocess_button = pn.widgets.Button(
        label="Run ls -l in subprocess", button_type="primary"
    )
    ...
    run_bash_in_subprocess_button = pn.widgets.Button(
        label="Run bash in subprocess", button_type="primary"
    )
