...
def test_discrete_player(document, comm):
    discrete_player = DiscretePlayer(label='DiscretePlayer', value=1.,
...
def test_player_loop_policy_not_in_loop_options(document, comm):
    player = DiscretePlayer(label='Player', loop_policy='once', visible_loop_options=['loop', 'reflect'])
...
def test_player_loop_policy_with_no_loop_options(document, comm):
    player = DiscretePlayer(label='Player', loop_policy='loop', visible_loop_options=[])
    assert player.loop_policy == 'loop'
