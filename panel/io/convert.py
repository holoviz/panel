...
PYSCRIPT_CSS = f'<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@pyscript/core@{PYSCRIPT_VERSION}/dist/core.css" />'
PYSCRIPT_CSS_OVERRIDES = f'<link rel="stylsheet" href="{CDN_DIST}css/pyscript.css" />'
PYSCRIPT_JS = f'<script type="module" src="https://cdn.jsdelivr.net/npm/@pyscript/core@{PYSCRIPT_VERSION}/dist/core.js"></script>'
