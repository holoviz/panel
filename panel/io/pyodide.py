...
def pyrender(
    ...
    """
    from ..pane import (
        HoloViews, Interactive, ReactiveExpr, panel as as_panel,
    )
    ...
    ret = {}
    if isinstance(out, (Model, Viewable, Viewer)) or HoloViews.applies(out) or Interactive.applies(out) or ReactiveExpr.applies(out):
