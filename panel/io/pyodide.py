...
def _serialize_buffers(obj, buffers={}):
    ...
    if isinstance(obj, dict):
        return {key: _serialize_buffers(o, buffers=buffers) for key, o in obj.items()}
    elif isinstance(obj, list):
        return [_serialize_buffers(o, buffers=buffers) for o in obj]
    elif isinstance(obj, tuple):
        return tuple(_serialize_buffers(o, buffers=buffers) for o in obj)
