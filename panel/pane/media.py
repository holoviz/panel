...
def _is_1dim_int_or_float_ndarray(obj: Any) -> bool:
    return isinstance(obj, np.ndarray) and obj.ndim == 1 and obj.dtype in _VALID_NUMPY_DTYPES_FOR_AUDIO
...
class Audio(_MediaBase):
    ...
    @classmethod
    def applies(cls, obj: Any) -> float | bool | None:
        return super().applies(obj) or _is_1dim_int_or_float_ndarray(obj) or _is_1dim_int_or_float_tensor(obj)
