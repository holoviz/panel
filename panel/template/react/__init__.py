...
class ReactTemplate(BasicTemplate):
    ...
    dimensions = param.Dict(
        default={"minW": 0, "maxW": float("inf"), "minH": 0, "maxH": float("inf")}, doc="""A dictionary of minimum/maximum width/height in grid units."""
    )
    ...
    _resources = {
        ...
        "css": {"font-awesome": CSS_URLS["font-awesome"]},
    }
