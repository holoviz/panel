...
class FastListTemplate(FastBaseTemplate):
    """
    The FastListTemplate is a list based Template with a header, sidebar and main area. Its based
    on the fast.design style and works well in both default (light) and dark mode.
