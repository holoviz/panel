...
class FastBaseTemplate(BasicTemplate):
    ...
    font_url = param.String(
        doc="""
        A font url to import."""
    )

    header_neutral_color = param.Color(
        doc="""
        Optional header neutral color override."""
    )

    header_accent_base_color = param.Color(
        doc="""
