...
REVEAL_THEME_CSS = {f"reveal-{theme}": f"{pn_config.npm_cdn}/reveal.js@4.5.0/dist/theme/{theme}.css" for theme in REVEAL_THEMES}
...
class SlidesTemplate(VanillaTemplate):
    ...
    reveal_config = param.Dict(
        default={},
        doc="""
        Configuration parameters for reveal.js""",
    )

    reveal_theme = param.Selector(
        default=None,
        objects=REVEAL_THEMES,
        doc="""
