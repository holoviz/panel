...
```python
float_slider = pn.widgets.FloatSlider(label='Float Slider', start=0, end=3.141, step=0.01, value=1.57)
...
str_format = pn.widgets.FloatSlider(label='Distance', format='1[.]00')

tick_format = pn.widgets.FloatSlider(label='Distance', format=PrintfTickFormatter(format='%.3f m'))
