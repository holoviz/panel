...
You can select the theme of Altair plots using `altair.themes.enable` and an accent color using the `configure_mark` method. The list of themes is available via `altair.themes.names()`.
