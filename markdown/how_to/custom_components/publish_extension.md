...
The `copier-template-panel-extension` generates a project pre-configured with:
...
Browse the [panel-extensions](https://github.com/orgs/panel-extensions/repositories) organization on GitHub to see community extensions built on Panel's custom component APIs. You may also open a PR to add your custom extension below.
