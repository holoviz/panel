...
In this tutorial, we will create a *bar chart race* using the [Altair](https://altair-viz.github.io) plotting library and the `Player` widget.
...
Let's make it interactive! We introduce a `Player` widget to loop continuously through the years.
...
In this tutorial, we built a *bar chart race* using the [Altair](https://altair-viz.github.io) plotting library and the `Player` widget.
