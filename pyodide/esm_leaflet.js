...
async function startApplication() {
  ...
  const env_spec = ['https://cdn.holoviz.org/panel/wheels/bokeh-3.6.0-py3-none-any.whl', 'https://cdn.holoviz.org/panel/1.5.3/dist/wheels/panel-1.5.3-py3-none-any.whl', 'pyodide-http==0.2.1', 'numpy', 'pandas', 'param']
