...
async function startApplication() {
  ...
  try {
    await self.pyodide.runPythonAsync(`
      import micropip
      await micropip.install(['https://cdn.holoviz.org/panel/wheels/bokeh-3.9.0-py3-none-any.whl', 'https://cdn.holoviz.org/panel/1.8.10/dist/wheels/panel-1.8.10-py3-none-any.whl', 'pyodide-http', 'altair', 'plotly', 'hvplot', 'matplotlib']);
    `);
  } catch(e) {
    console.log(e)
    self.postMessage({
