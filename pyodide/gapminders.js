...
async function startApplication() {
  ...
  try {
    await self.pyodide.runPythonAsync(`
      import micropip
      await micropip.install(['https://cdn.holoviz.org/panel/wheels/bokeh-3.8.2-py3-none-any.whl', 'https://cdn.holoviz.org/panel/1.8.9/dist/wheels/panel-1.8.9-py3-none-any.whl', 'pyodide-http', 'altair', 'plotly', 'hvplot', 'matplotlib']);
    `);
  } catch(e) {
    console.log(e)
    self.postMessage({
