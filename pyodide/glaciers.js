...
async function startApplication() {
  ...
  const data_archives = ['glaciers.resources.zip'];
  ...
  try {
    await self.pyodide.runPythonAsync(`
      import micropip
      await micropip.install(['https://cdn.holoviz.org/panel/wheels/bokeh-3.8.0-py3-none-any.whl', 'https://cdn.holoviz.org/panel/1.8.1/dist/wheels/panel-1.8.1-py3-none-any.whl', 'pyodide-http', 'holoviews', 'colorcet', 'hvplot']);
    `);
  } catch(e) {
    console.log(e)
    self.postMessage({
