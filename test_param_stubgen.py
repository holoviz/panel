from param_stubgen import get_parameterized_classes, _to_bases, _to_class_name, to_stub, _to_typed_attributes, _to_typehint, _default_to_string, _to_init
...
@pytest.mark.parametrize(["parameter", "typehint"], [
    (param.Boolean(), 'bool=False',),
    (param.Boolean(default=None), 'Optional[bool]=None',),
    (param.Color(), 'Optional[str]=None',),
    (param.Color("#aabbcc", allow_None=False), 'str="#aabbcc"',),
    (param.Integer(), 'int=0'),
    (param.List(), 'list=[]'),
    ...
    (param.ClassSelector(default="test", class_=(str, int), allow_None=True), 'Optional[Union[int,str]]="test"'),
...
def test_to_typed_attributes():
    parameterized = slider.IntSlider
    assert _to_typed_attributes(parameterized)=="""\
    value: int=0
