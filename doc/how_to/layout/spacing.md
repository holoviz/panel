...
pn.Row(
    pn.Column((label='B1', width=100, margin=25), styles={'background': '#f0f0f0'}),
    pn.Column((label='B2', width=100, margin=(40, 50)), styles={'background': '#f0f0f0'}),
    pn.Column((label='B3', width=100, margin=(25, 50, 75, 100)), styles={'background': '#f0f0f0'}))
