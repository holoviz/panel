...
If we place objects in a [*layout*](../../reference/index.md#layouts) like [`pn.ui.Column`](../../reference/layouts/Column.md) (more about layouts later), then the layout will apply `pn.panel` for us automatically.
...
`pn.panel` is a versatile helper function that converts objects into a [*Pane*](../../reference/index.md#panes). It automatically selects the best *representation* for an object based on available [*Pane*](../../reference/index.md#panes) types, ranking them by priority.
